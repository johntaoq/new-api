...
import { EnterpriseHome } from './components/sections/enterprise-home'
...
export function Home() {
  ...
  return (
    <PublicLayout
      ...
      logo={
        <img
          src='/unikeyx-logo.png'
          alt='UniKeyX'
          className='size-full rounded-lg object-cover'
        />
      }
      siteName='UniKeyX'
      headerProps={{ className: 'ukx-home-header' }}
    >
      <EnterpriseHome isAuthenticated={isAuthenticated} />
    </PublicLayout>
  )
}
