...
func TestMain(m *testing.M) {
	...
	if err := db.AutoMigrate(&Task{}, &User{}, &Token{}, &Log{}, &Channel{}, &Redemption{}, &CardIssue{}, &FinancialAuditLog{}); err != nil {
...
func truncateTables(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		DB.Exec("DELETE FROM card_issues")
		DB.Exec("DELETE FROM financial_audit_logs")
	})
}
